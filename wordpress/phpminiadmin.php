    ...
    */
    ...
    jQuery(function($) {
      ...
      $(document).ready(function() {
          ...
          $chkboxes
            .on('click', function(e) {
              ...
              if(e.shiftKey) {
                  ...
                  $chkboxes.slice(Math.min(start,end), Math.max(start,end)+ 1).attr('checked', lastChecked.checked).trigger('change');
          ...
          $('.res tbody tr').not(':eq(0)').hover(function() {
            $(this).addClass('h');
          }, function() {
            $(this).removeClass('h');
          });
